package net.lucasoligar.newcores;
...
@Mod(NewCoresMod.MODID)
public class NewCoresMod {
    public static final String MODID = "newcores";
    private static final Logger LOGGER = LogUtils.getLogger();

    public NewCoresMod(FMLJavaModLoadingContext context) {
